...
0000000000400ee0 <phase_1>:
  ...
  400ee4:	be 00 24 40 00       	mov    $0x402400,%esi //设置第二个参数
  400ee9:	e8 4a 04 00 00       	callq  401338 <strings_not_equal> //比较两个字符串是否相同
  400eee:	85 c0                	test   %eax,%eax  //测试返回值是否为0
  400ef0:	74 05                	je     400ef7 <phase_1+0x17>  //相等则跳过爆炸函数的调用
...
0000000000400efc <phase_2>:
  400efc:	55                   	push   %rbp
  400efd:	53                   	push   %rbx
  400efe:	48 83 ec 28          	sub    $0x28,%rsp //分配栈空间，用于保存局部变量
  400f02:	48 89 e6             	mov    %rsp,%rsi  //将栈指针作为第二个参数传入
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>  //读取六个数字
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)  //检验第一个数是否为1
  400f0e:	74 20                	je     400f30 <phase_2+0x34>  //相等则跳转到400f30
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax  //复制原本数字
  400f1a:	01 c0                	add    %eax,%eax  //乘2
  400f1c:	39 03                	cmp    %eax,(%rbx)  //比较下一个数字是否为上一个数字二倍
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx
  400f29:	48 39 eb             	cmp    %rbp,%rbx  //相等则结束循环
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx //%rbx指向下一个数字
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp  //循环结束条件
...
0000000000400f43 <phase_3>:
  ...
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx //设置scanf的参数
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi //$0x4025cf处的值为"%d %d"，作为scanf的第二个参数
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  400f60:	83 f8 01             	cmp    $0x1,%eax  //scanf函数的返回值为已成功赋值的数据项数，此处应大于1
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp) //第一个数大于7则爆炸
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax //将第一个数值传给%rax
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8) //跳转至0x402470+%rax*8
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax //8组数值任选一组
  ...
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax //比较输入的第二个值是否正确
...
0000000000400fce <func4>:
  ...
  400fdd:	d1 f8                	sar    %eax //算数右移一位，%eax=7
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx //%ecx=7+0=7
  400fe2:	39 f9                	cmp    %edi,%ecx  //x和7比较
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>  //小于等于7跳转
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx  //否则%edx=6
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>   //重新执行func4
  400fee:	01 c0                	add    %eax,%eax
  400ff0:	eb 15                	jmp    401007 <func4+0x39>
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax  //%eax=0
  400ff7:	39 f9                	cmp    %edi,%ecx  //若x=7，则可成功返回
...
000000000040100c <phase_4>:
  ...
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx //设置scanf读取的数二(以下记为y)的地址
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx //设置scanf读取的数一(以下记为x)的地址
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi //%d %d
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax      
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  401029:	83 f8 02             	cmp    $0x2,%eax  //sscanf读取两个数下x和y，否则爆炸
  40102c:	75 07                	jne    401035 <phase_4+0x29>
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp) //0<=x<=14
  401033:	76 05                	jbe    40103a <phase_4+0x2e>  //jbe是比较无符号数，小于零的数也被排除
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx  //设置func4第三个参数为14
  40103f:	be 00 00 00 00       	mov    $0x0,%esi  //第二个参数为0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi //第一个参数为x
  401048:	e8 81 ff ff ff       	callq  400fce <func4> //调用函数
  40104d:	85 c0                	test   %eax,%eax  //测试返回值是否等于0
  40104f:	75 07                	jne    401058 <phase_4+0x4c>
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp) //比较y是否为0
...
0000000000401062 <phase_5>:
  ...
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax  //Canary栈保护
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
  401078:	31 c0                	xor    %eax,%eax  //置零
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length>
  40107f:	83 f8 06             	cmp    $0x6,%eax  //字符串长度应为6
  401082:	74 4e                	je     4010d2 <phase_5+0x70>
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx //读取字符串
  40108f:	88 0c 24             	mov    %cl,(%rsp) //截取一个字符
  401092:	48 8b 14 24          	mov    (%rsp),%rdx
  401096:	83 e2 0f             	and    $0xf,%edx  //取字符值的低四位作为偏移地址
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx  //读取该地址的字符
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)  //存入栈中
  4010a4:	48 83 c0 01          	add    $0x1,%rax
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>  //循环
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)  //添加字符串结束符
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi //参数二，该地址所在的字符串
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi  //参数一，栈中存储的字符串
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal> //相等则成功
...
00000000004010f4 <phase_6>:
  ...
  401103:	48 89 e6             	mov    %rsp,%rsi  //将栈指针作为第二个参数传入
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers>  //读取六个数字存在栈里
  40110b:	49 89 e6             	mov    %rsp,%r14  
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d
  401114:	4c 89 ed             	mov    %r13,%rbp
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax
  40111b:	83 e8 01             	sub    $0x1,%eax
  40111e:	83 f8 05             	cmp    $0x5,%eax  //第一个数在1~6之间
  ...
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp) //后续数应与第一个数不同
  40113e:	75 05                	jne    401145 <phase_6+0x51>
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx
  401148:	83 fb 05             	cmp    $0x5,%ebx
  40114b:	7e e8                	jle    401135 <phase_6+0x41>  //循环比较
  40114d:	49 83 c5 04          	add    $0x4,%r13  //指向下一个数
  401151:	eb c1                	jmp    401114 <phase_6+0x20>  //即实现每个数不同
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi  //指向六个数字的末尾，作为后续循环结束条件
  401158:	4c 89 f0             	mov    %r14,%rax
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx
  401160:	89 ca                	mov    %ecx,%edx
  401162:	2b 10                	sub    (%rax),%edx
  401164:	89 10                	mov    %edx,(%rax)  //x=7-x
  401166:	48 83 c0 04          	add    $0x4,%rax  //指向下一个数
  40116a:	48 39 f0             	cmp    %rsi,%rax
  40116d:	75 f1                	jne    401160 <phase_6+0x6c> //此段循环实现每个数x=7-x
  40116f:	be 00 00 00 00       	mov    $0x0,%esi
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx //更新为下个结点的地址
  40117a:	83 c0 01             	add    $0x1,%eax  //计数加一
  40117d:	39 c8                	cmp    %ecx,%eax
  40117f:	75 f5                	jne    401176 <phase_6+0x82>
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) //地址入栈
  40118d:	48 83 c6 04          	add    $0x4,%rsi
  401191:	48 83 fe 18          	cmp    $0x18,%rsi
  401195:	74 14                	je     4011ab <phase_6+0xb7>  //通过循环将结点地址按数字顺序存入栈中
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx //读取栈中数字
  40119a:	83 f9 01             	cmp    $0x1,%ecx
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx  //设置的表头地址
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax  //指向栈中第二个地址的指针
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi  //边界条件
  4011ba:	48 89 d9             	mov    %rbx,%rcx
  4011bd:	48 8b 10             	mov    (%rax),%rdx
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx) //设置Next指针
  4011c4:	48 83 c0 08          	add    $0x8,%rax
  4011c8:	48 39 f0             	cmp    %rsi,%rax
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>
  4011cd:	48 89 d1             	mov    %rdx,%rcx
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx) //设置链尾指向NULL
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax //Next指针
  4011e3:	8b 00                	mov    (%rax),%eax
  4011e5:	39 03                	cmp    %eax,(%rbx)  //
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>  //前结点value>后结点value
...
0000000000401204 <fun7>:
  ...
  401208:	48 85 ff             	test   %rdi,%rdi  //检验是否为NULL
...
0000000000401242 <secret_phase>:
  401242:	53                   	push   %rbx
  401243:	e8 56 02 00 00       	callq  40149e <read_line> //read_line的返回值保存在%rax
  401248:	ba 0a 00 00 00       	mov    $0xa,%edx
  40124d:	be 00 00 00 00       	mov    $0x0,%esi
  401252:	48 89 c7             	mov    %rax,%rdi  //设置断点打印后可发现就是我们输入的值
  401255:	e8 76 f9 ff ff       	callq  400bd0 <strtol@plt>
  40125a:	48 89 c3             	mov    %rax,%rbx
  40125d:	8d 40 ff             	lea    -0x1(%rax),%eax
  401260:	3d e8 03 00 00       	cmp    $0x3e8,%eax  //输入的值大于0x3e8直接爆炸
  401265:	76 05                	jbe    40126c <secret_phase+0x2a>
  401267:	e8 ce 01 00 00       	callq  40143a <explode_bomb>
  40126c:	89 de                	mov    %ebx,%esi  //我们输入的值
  40126e:	bf f0 30 60 00       	mov    $0x6030f0,%edi //二叉树的根结点地址
...
000000000040131b <string_length>:
  40131b:	80 3f 00             	cmpb   $0x0,(%rdi)  //是否是结束字符
  40131e:	74 12                	je     401332 <string_length+0x17>
  401320:	48 89 fa             	mov    %rdi,%rdx  
  401323:	48 83 c2 01          	add    $0x1,%rdx  //若不是，%rdx=%rax+1
  401327:	89 d0                	mov    %edx,%eax
  401329:	29 f8                	sub    %edi,%eax  //通过差值计算字符串长度
...
0000000000401338 <strings_not_equal>:
  ...
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx
  40133c:	48 89 fb             	mov    %rdi,%rbx  //保存第一个参数(输入的字符串地址)
  40133f:	48 89 f5             	mov    %rsi,%rbp  //保存第二个参数($0x402400处的字符串地址)
  401342:	e8 d4 ff ff ff       	callq  40131b <string_length> //计算输入的字符串长度
  401347:	41 89 c4             	mov    %eax,%r12d //结果存入%r12d
  40134a:	48 89 ef             	mov    %rbp,%rdi  //初始化参数
  40134d:	e8 c9 ff ff ff       	callq  40131b <string_length> //计算$0x402400处的字符串长度
  401352:	ba 01 00 00 00       	mov    $0x1,%edx  //预设返回值为1，后面不等会传给%rax
  401357:	41 39 c4             	cmp    %eax,%r12d //比较字符串长度是否相等
  40135a:	75 3f                	jne    40139b <strings_not_equal+0x63>  //不等跳转到40139b
  40135c:	0f b6 03             	movzbl (%rbx),%eax  //传入输入字符串的内容
  40135f:	84 c0                	test   %al,%al  //测试是否为结束字符
  401361:	74 25                	je     401388 <strings_not_equal+0x50>
  401363:	3a 45 00             	cmp    0x0(%rbp),%al  //比较第一个字符
  401366:	74 0a                	je     401372 <strings_not_equal+0x3a>  //通过跳转实现循环比较字符串
  401368:	eb 25                	jmp    40138f <strings_not_equal+0x57>
  40136a:	3a 45 00             	cmp    0x0(%rbp),%al
  40136d:	0f 1f 00             	nopl   (%rax)
  401370:	75 24                	jne    401396 <strings_not_equal+0x5e>
  401372:	48 83 c3 01          	add    $0x1,%rbx  //指针+1，比较后续字符
  ...
  401388:	ba 00 00 00 00       	mov    $0x0,%edx  //设置返回值为0
  40138d:	eb 0c                	jmp    40139b <strings_not_equal+0x63>
  40138f:	ba 01 00 00 00       	mov    $0x1,%edx
  401394:	eb 05                	jmp    40139b <strings_not_equal+0x63>
  401396:	ba 01 00 00 00       	mov    $0x1,%edx
  40139b:	89 d0                	mov    %edx,%eax  //设置返回值为1
  40139d:	5b                   	pop    %rbx
  40139e:	5d                   	pop    %rbp
...
000000000040145c <read_six_numbers>:
  ...
  401460:	48 89 f2             	mov    %rsi,%rdx  //第一个参数
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx //第二个
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp) //第六个
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax
  401474:	48 89 04 24          	mov    %rax,(%rsp)  //第五个
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9  //第四个
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8  //第三个
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi //%d %d %d %d %d %d
  401485:	b8 00 00 00 00       	mov    $0x0,%eax
  40148a:	e8 61 f7 ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  40148f:	83 f8 05             	cmp    $0x5,%eax  //检验是读取的数字个数是否大于5个
